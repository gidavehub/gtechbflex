...
import {
  ...
  ArrowRight, ArrowLeft, CheckCircle, Loader2, Sparkles, Send, Home,
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50/50 flex flex-col">
      ...
      <footer className="text-center py-6 border-t border-gray-100 bg-white">
        <div className="flex items-center justify-center gap-2 mb-1">
          <Image src="/logo.webp" alt="Gambia Tech" width={20} height={20} className="rounded" />
    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-gray-100">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 hover:opacity-80 transition-opacity">
          <Image src="/logo.webp" alt="Gambia Tech" width={28} height={28} className="rounded-lg" />
          <span className="text-base font-bold text-gray-900">Gambia Tech</span>
        </Link>
        <div className="flex items-center gap-2">
          <Link
            href="/"
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-all"
          >
            <Home size={13} /> Home
          </Link>
          <Link
            href="/apply"
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-gold-500 text-white hover:bg-gold-600 transition-all shadow-sm"
          >
            Apply Now
          </Link>
        </div>
